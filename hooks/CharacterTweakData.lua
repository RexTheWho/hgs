Hooks:PostHook(CharacterTweakData, "init", "init_hgs", function(self, tweak_data)

	-- Adding Characters (Needs reworking, local overriding functions bad)
	function CharacterTweakData:character_map()
		local char_map = {
			hgs_gunstore = {
				path = "units/pd2_mod_hgs/characters/",
				list = {
					"civ_male_our_guy",
					"civ_male_manager"
				}
